...
namespace PEIaPP.Models
{
    public static class repository
    {
        ...
        public static List<pckeyvalue> getlistofnewstoresandrestaurants()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.New_Stores_and_Restaurants
        ...
        {
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.FTEs
                           select new pckeyvalue()
                           {
                               PC_KEY = emp.PC_KEY,
                               VALUE = emp.VALUE
        ...
        {
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.Rehabs
        ...
        public static List<pckeyvalue> getlistofrehabcamping()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.Campings
        ...
        public static List<pckeyvalue> getlistofMTHREST()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.MTheRests
        ...
        public static List<pckeyvalue> getlistofmtourism()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.MTourism
        ...
        public static List<pckeyvalue> getlistofmcapital()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.MCapitals
        ...
        public static List<pckeyvalue> getlistfriendsandfamily()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.Friends_and_Families
        ...
        public static GeneralInfo getfirstvaluogf_from_GeneralInfo()
        {
            ...
            PEIEntities7 db = new PEIEntities7();
            var empQuery = (from emp in db.GeneralInfoes
        ...
        public static double[] getlistof1to17columnsvaluesin160row_Distribution()
        {
            ...
            for (int i = 0; i < 18; i++)
                li[i] = 0;
            PEIEntities7 db = new PEIEntities7();
            Distribution empQuery = (from v in db.Distributions
                                     where v.ID == 160
                                     select v).FirstOrDefault();
            // db.Distributions.Where(p => p.ID == 160);
        ...
        public static double[] getlistofcolumnnameis0to17columnsvaluesfrom_GeneralInfo()
        {
            ...
            GeneralInfo empQuery = db.GeneralInfoes.FirstOrDefault();
            if (1 < 2)
            {
                li[0] = empQuery.C0 ?? 0;
                li[1] = empQuery.C1 ?? 0;
        ...
        {
            PEIEntities7 db = new PEIEntities7();
            var empQuery = from emp in db.ZNewIoCodes
                           where emp.PC_KEY == i
                           select emp;
        ...
        public static List<regionclassp> getRIOandp_orderbyRIO_from_defaultdata(string regionname)
        {
            ...
            //var v = (from c in db.spAlabama_DefaultData(regionname + "_DefaultData").ToList()
            //        orderby c.RIO
            //        select new regionclassp { p = c.P }
            //        ).ToList();
            if (regionname != null)
            {
                empList = (from emp in db.spAlabama_DefaultData(regionname + "_DefaultData").ToList()//db.Alabama_DefaultData
                           orderby emp.RIO
        ...
        public static List<regionclassp> getRIOandp_orderbyRIO_from_defaultdata()
        {
            ...
            empList = (from emp in db.DefaultDatas
                       orderby emp.RIO
        ...
        public static List<LeontievInversegeneric> getalldatafor_LeontievInverse(String regionname)
        {
            ...
            if (regionname != null)
            {
                var empQuery = from emp in db.spAlabama_LeontievInverse(regionname + "_LeontievInverse").ToList()//Ganesh.Alabama_LeontievInverse
        ...
        public static double[,] getdefaultdataon_rio_inc(string regionname)
        {
            ...
            if (regionname != null)
            {
                var empQuery = from emp in db.spAlabama_DefaultData(regionname + "_DefaultData").ToList()//Ganesh.Alabama_DefaultData
        ...
        public static List<tempclass> getidandpfrompnationasfirstsecond()
        {
            ...
            var empQuery = from emp in db.P_nation_
        ...
        public static List<generic_DefaultData> getdefaultrecords(String regionname)
        {
            ...
            if (regionname.Substring(regionname.Length - 4) == "Rest")
            {
                var empQuery = from emp in db.spAlabamaRest_DefaultData(regionname + "_DefaultData").ToList()//Ganesh.AlabamaRest_DefaultData
                               orderby emp.RIO
                               select new generic_DefaultData
                               {
                                   RIO = emp.RIO,
        ...
        {
            PEIEntities7 db = new PEIEntities7();
            var empQuery = (from emp in db.tblGeneralIndustries
                            select emp).ToList();
            return empQuery;
        ...
        public static double[] getgeneralindustryrecordasarray()
        {
            ...
            var xx = db.tblGeneralIndustries.FirstOrDefault();
            int j = 0;
            double d = 0;
        ...
        public static double[] geteconomicbaseasarray()
        {
            ...
            var xx = db.tblEconomicBases.FirstOrDefault();
            int j = 0;
        ...
        public static tblIndustry gettbinduustryobjectbySIC(int i)
        {
            ...
            empQuery = db.tblIndustries.Where(o => o.SIC.Value.Equals(i)).FirstOrDefault();
        ...
        public static List<tblOccupation> getallOccupationecordsorderbyid()
        {
            ...
            empQuery = db.tblOccupations.ToList();//.OrderBy(p => p.OccupationID)
        ...
        public static double[] getpopulationcolumnasarrayfromAreatablesofallregions(string region_name)
        {
            ...
            if (region_name != null)
            {
                ...
                two[1] = db.spAlabama_Area(region_name + "_Area").ToList().FirstOrDefault().Population ?? default(double);
                two[0] = db.spAlabamaRest_Area(region_name + "Rest_Area").ToList().FirstOrDefault().Population ?? default(double);
        ...
        public static List<generic_AMatrix> getregioanlamtrix(string region_name)
        {
            ...
            {
                var empQuery = from emp in db.spAlabama_AMatrix(region_name + "_AMatrix ").ToList()//Ganesh.Alabama_AMatrix   
            ...
            if (region_name.Substring(region_name.Length - 4) == "Rest")//instead of name check last 4 letters rest
            {
                ...
                var empQuery = from emp in db.spz_AlabamaRest_AMatrix(region_name + "_AMatrix ").ToList() //Ganesh.z_AlabamaRest_AMatrix   //z_AlabamaRest_AMatrix
                               select new generic_AMatrix { ID = emp.ID, VALUE = emp.VALUE };
                empList = empQuery.ToList();
            }
        ...
        {
            PEIEntities7 db = new PEIEntities7();
            var empQuery = (from emp in db.JointVentures
                            select emp).ToList();
            return empQuery;
        }
    }
